...
sealed class WebSocketEvent {
    ...
    data class DeploymentNew(val deployment: Deployment) : WebSocketEvent()
    data class DeploymentUpdate(val update: com.openclaw.console.data.model.DeploymentUpdate) : WebSocketEvent()
    data class DeploymentStepUpdate(val update: com.openclaw.console.data.model.DeploymentStepUpdate) : WebSocketEvent()
    data class DeploymentCompleted(val deployment: Deployment) : WebSocketEvent()
