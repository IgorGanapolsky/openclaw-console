...
class InternalDistributionContractTest(unittest.TestCase):
    ...
    def test_setup_script_collects_distribution_proof_inputs(self):
        ...
        self.assertIn("Release workflow is still blocked. Missing required secrets:", SETUP_SCRIPT)
        self.assertIn("Ready: $SECRETS_SET secrets configured and required repo/production checks passed.", SETUP_SCRIPT)
