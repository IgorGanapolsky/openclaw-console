...
export class McpManager {
  ...
  public async executeGitOperation(
    ...
    try {
      ...
      const outputText = firstContent && 'text' in firstContent ? firstContent.text : JSON.stringify(result);
    ...
    switch (operation) {
      case 'commit':
        return {
          ...
          commit_message: args.message as string | undefined,
          file_changes: args.files as string[] | undefined,
        };
      case 'push':
        return {
          operation_type: 'push',
          branch_to: args.branch as string | undefined,
        };
      case 'merge':
        return {
          operation_type: 'merge',
          branch_from: args.source as string | undefined,
          branch_to: args.target as string | undefined,
        };
      default:
        return undefined;
    }
